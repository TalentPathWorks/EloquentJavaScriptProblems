 ...
 * 80 percent of cases raises an exception of type
 * MultiplicatorUnitFailure. Write a function that wraps this
 * clunky function and just keeps trying until a call
 * succeeds, after which it returns the result.
 * 
 * Make sure you handle only the exceptions you are trying to
 * handle.
 */
...
*/
/**
 * It is a box with a lock. There is an array in the box, but
 * you can get at it only when the box is unlocked. Directly
 * accessing the private _content property is forbidden.
 * 
